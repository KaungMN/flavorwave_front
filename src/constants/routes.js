...
export const PRODUCT_PAGE_ROUTE = '/all-products';
export const ORDER_ADDRESS_PAGE_ROUTE = '/order/address';
export const ORDER_CONFIRMATION_PAGE_ROUTE = '/order/confirmation';
